...
import Footer from '@/components/template/footer/component/Footer'
import type { CommonProps } from '@/@types/common'
import type { Meta } from '@/@types/routes'
import type { ElementType, ComponentPropsWithRef } from 'react'
import type { FooterPageContainerType } from '@/components/template/footer/component/Footer'
...
const PageContainer: React.FC<PageContainerProps> = ({
    ...
    //! add file name for translation 
    const { t } = useTranslation([''])

    return (
        <div className="h-full flex flex-auto flex-col justify-between bg-gray-100">
