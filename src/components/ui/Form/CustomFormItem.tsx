...
const CustomFormItem = forwardRef<HTMLDivElement, FormItemProps>(
    (props, ref) => {
        const {
            asterisk,
            children,
        ...
        const enterStyle = { opacity: 1, marginTop: 1, bottom: -14 }
            ...
            <div ref={ref} className={formItemClass}>
                ...
                >
                    <div className="flex items-center gap-1">
                        {icon && (
                            <p className="mr-[.1rem] text-[.95rem]">{icon}</p>
                        )}
                        <div>
                            {label}
